function [q, qd, qdd] = simulateChangingRobo(s, torque)
    % Simulate a robot with time-variant dynamic parameters
    ...
    for iter = 2:NUM_ITER
        ...
        qd_now = qd(iter-1, :);
        t_now = (iter - 1) * dt;
        robot = buildPlaneMan(s(iter,:)); % TODO change buildPlaneMan call
